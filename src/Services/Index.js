...
function Index() {
  ...
  async function getAccountBalance() {
    // console.log((await web.eth.getBalance(account)) / Math.pow(10, 18));
    let balance = (await web.eth.getBalance(accountAddress)) / Math.pow(10, 18);
    return balance;
  }

  // async function getAccountChainId() {
  //   // console.log(await web.eth.getChainId());
  //   let chainID = await web.eth.getChainId();
  //   return chainID;
  // }
